...
import khusboo from './images/khusboomam.jpg'
//certificate
// import ReactDev from "./certificates/Amcat.jpg";
...
// const [isModalOpen, setIsModalOpen] = useState(false);
  ...
  issuer: "Udemy",
  date: "Jan 2025",
  src:  aibuilder // if img is an imported variable
},
    {
      name: "AMCAT",
      issuer: "NPTEL",
...
<a
  href="/Resume/Ajmer_Lodhi_Resume.pdf"
  download="Ajmer_Lodhi_Resume.pdf"
  className="px-6 py-3 rounded-xl font-medium text-lg 
      ...
      {services.map((service, index) => (
        ...
        >
          ...
          <div className="absolute inset-0 rounded-2xl bg-gradient-to-r from-cyan-500/10 to-purple-600/10 
                          opacity-0 group-hover:opacity-30 blur-2xl transition duration-700"></div>
        </div>
      ))}
    </div>
  </div>
